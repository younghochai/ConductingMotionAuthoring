...
public class SMPLX : MonoBehaviour
{
    ...
    //    joint.localRotation = Quaternion.Inverse(jointParent.rotation) * Quaternion.Inverse(Quaternion.Euler(180.0f, 0.0f, 0.0f)) * quatWorld * Quaternion.Euler(0.0f, 0.0f, 180.0f);
    //}
